...
<div class="main-card mb-3 card mt-4">
	<div class="card-header-tab card-header-tab-animation card-header">
		<div class="card-header-title font-size-lg text-capitalize font-weight-normal">
			<i class="fas fa-city"></i>Промени населено място
		</div>
	</div>
			...
			<div>
				...
				<form method="POST" action='{{ url("cities/$city->id") }}'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $city->name }}" required autofocus>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <select name="region_id" id="region_id" class="form-control" required>
                                ...
                                @foreach($regions as $region)
                                    <?php $selected = Helper::is_selected($city->region_id, $region->id); ?>
